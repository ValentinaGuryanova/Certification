    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.IntegerField(choices=[('0', 'Завод'), ('1', 'Розничная сеть'), ('2', 'Индивидуальный предприниматель')], verbose_name='Уровень поставщика')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('debt', models.DecimalField(decimal_places=2, default=0, max_digits=10, verbose_name='Задолженность поставщику')),
